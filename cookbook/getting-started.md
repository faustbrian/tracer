...
- **[Basic Usage](basic-usage.md)** - Deep dive into revision tracking
- **[Staged Changes](staged-changes.md)** - Complete staging workflow guide
- **[Approval Workflows](approval-workflows.md)** - Configure approval strategies
- **[Strategies](strategies.md)** - Customize diff calculation
- **[Advanced Usage](advanced-usage.md)** - Events, custom strategies, and more
