 ...
 * @method static bool                                apply(StagedChange $stagedChange, ?Model $appliedBy = null, null|StagedConflictResolution|string $mode = null, array<string, mixed> $resolvedValues = []) Apply an approved staged change to its target model
 ...
 * @method static array<string, array<string, mixed>> detectConflicts(StagedChange $stagedChange)                                                                                                               Detect conflicts before applying a staged change
 ...
 * @method static bool                                hasConflicts(StagedChange $stagedChange)                                                                                                                  Determine whether a staged change currently conflicts
 ...
 * @method static void                                resolveConflicts(StagedChange $stagedChange, StagedConflictResolution|string $mode, array<string, mixed> $resolvedValues = [])                            Persist a conflict resolution mode for a staged change
