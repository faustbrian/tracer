...
use Cline\Tracer\Database\Models\StagedChangeApproval;
...
final class TracerServiceProvider extends PackageServiceProvider
{
    ...
    public function bootingPackage(): void
    {
        ...
        /** @var string $primaryKeyTypeValue */
        $primaryKeyTypeValue = config('tracer.primary_key_type', 'id');
        $primaryKeyType = PrimaryKeyType::from($primaryKeyTypeValue);
